                    ...
                    <form>
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label for="exampleInputEmail1" class="font-weight-bold">Tipe Laporan</label>
                                <select class="form-control" name="type">
                                    <option value="harian" <?= (isset($_GET['type']) && $_GET['type'] == 'harian') || !isset($_GET['type']) ? 'selected' : ''; ?>>Laporan Harian</option>
                                    <option value="bulanan" <?= (isset($_GET['type']) && $_GET['type'] == 'bulanan') ? 'selected' : ''; ?>>Laporan Bulanan</option>
                                    <option value="tahunan" <?= (isset($_GET['type']) && $_GET['type'] == 'tahunan') ? 'selected' : ''; ?>>Laporan Tahunan</option>
                                </select>
                            </div>
                            <div class="form-group col-md-3">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                <td rowspan="2" style="height: 70px; line-height: 70px; text-align: center;" class="font-weight-bold">Tanggal / Waktu</td>
                        ...
                        <tbody>
                            <?php foreach ($data as $key => $value) { ?>
                                <tr>
                                    <td class="text-center"><?= Report::convertDateTime($type, $value->tanggal); ?></td>
                                    <td class="text-center"><?= $value->total_in_progress; ?></td>
                                    <td class="text-center"><?= $value->total_in_done; ?></td>
                                    <td class="text-center"><?= $value->total_in_cancel; ?></td>
